...
const Front = () => {
    ...
    return (<>
      <Head>
        ...
        <meta property="og:title" content="Goldstack - JavaScript Starter Project Builder" key="title"/>
        <meta name="description" content="Goldstack provides high-quality starter projects tailored to your specific requirements using our starter project builder 🛠️."/>
        <meta property="og:description" content="Goldstack provides high-quality starter projects tailored to your specific requirements using our starter project builder 🛠️."/>
      </Head>
      <Header></Header>
      <main id="content">
        <Container className="space-top-1 space-top-md-2">
          ...
          <Row>
            {allTemplates().map((template, idx) => (<div className="col-md-4 mb-3 d-flex" key={idx}>
        ...
        <Container className="space-top-1 space-bottom-3 space-bottom-lg-3">
          ...
          <Row hidden>
            <Col xs={4}>
              <Foundation heading="Made for Joyful Development" features={[
            {
                icon: TypeScriptIcon,
                title: 'TypeScript',
            ...
            <Col xs={4}>
              <Foundation heading="Infrastructure Ready to Go" features={[
            {
                icon: TerraformIcon,
                title: 'Terraform',
            ...
            <Col xs={4}>
              <Foundation heading="Best-in-class Documentation" features={[
            {
                icon: DocusaurusIcon,
