...
const GetTemplatePage = () => {
    ...
    if (data === null || data === void 0 ? void 0 : data.paymentReceived) {
        (async () => {
      ...
      <Container className="space-2 space-lg-3">
        <Row className="justify-content-lg-between align-items-lg-center">
          <Col lg={6}>
            ...
            {data && !data.paymentReceived && (<ConfigureSession onConfigurationComplete={onConfigurationComplete} projectId={id} packageId={packageId} stripeId={data.stripeId}></ConfigureSession>)}
            {(data === null || data === void 0 ? void 0 : data.paymentReceived) && <p>User session already confirmed. Thank you!</p>}
          </Col>
...
//# sourceMappingURL=get-template.jsx.map