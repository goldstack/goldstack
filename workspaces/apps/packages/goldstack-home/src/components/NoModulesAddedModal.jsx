...
const NoModulesAddedModal = (props) => {
    return (<Modal id="noModulesModal" tabIndex={-1} role="dialog" aria-labelledby="noModulesModal" show={props.show}>
        ...
        <div className="modal-content">
          <div className="modal-header">
            ...
            <div className="modal-close">
              <button type="button" className="btn btn-icon btn-xs btn-ghost-secondary" aria-label="Close" onClick={props.handleAddModules}>
...
//# sourceMappingURL=NoModulesAddedModal.jsx.map