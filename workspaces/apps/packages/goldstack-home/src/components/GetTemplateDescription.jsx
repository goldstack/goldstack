...
const GetTemplateDescription = () => {
    ...
    return (<>
      <div className="mb-5">
        ...
        <p>
          Goldstack templates are carefully crafted and extensively tested to provide your project
    ...
    dangerouslySetInnerHTML={{ __html: checkCircle }} className="mt-1 mr-2"></FontIcon>
        <div className="media-body">
          Production-grade, serverless infrastrucure ready to roll out with Terraform on AWS
        </div>
      </div>
      <div className="media text-body mb-3">
        <FontIcon 
    ...
    // biome-ignore lint/security/noDangerouslySetInnerHtml: Required for SVG icon rendering
    dangerouslySetInnerHTML={{ __html: checkCircle }} className="mt-1 mr-2"></FontIcon>
        <div className="media-body">All components designed for easy local testing.</div>
      </div>
    </>);
};
export default GetTemplateDescription;
//# sourceMappingURL=GetTemplateDescription.jsx.map