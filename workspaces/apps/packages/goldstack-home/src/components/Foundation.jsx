...
const Foundation = (props) => {
    return (<div className="card h-100 transition-3d-hover">
      <div className="card-body">
        <h3 className="mb-3">{props.heading}</h3>
        {props.features.map((feature) => (<div className="media align-items-center mb-3" key={feature.title}>
            <figure className="w-100 max-w-5rem mr-3">
              <img className="img-fluid" src={feature.icon} alt=""/>
            </figure>
            <div className="media-body">
              <span className={styles.featureTitle} style={{
...
//# sourceMappingURL=Foundation.jsx.map