...
const ConfigureSession = (props) => {
    ...
    return (<form onSubmit={(evt) => evt.preventDefault()} className="js-validate card border w-md-85 w-lg-100 mx-md-auto">
      ...
      <div className="card-body p-md-6">
        <div className="row">
          <div className="col-sm-12 mb-3">
            ...
            <div className="js-form-message form-group">
              ...
              <input ref={emailInput} type="email" className="form-control" name="emailAddress" id="emailAddress" placeholder="Email address" aria-label="Email address" data-msg="Please enter a valid email address"/>
            </div>
          </div>
        </div>{' '}
        <div className="js-form-message mb-5">
          <small>
            ...
            <a href="/terms-and-conditions" className="link-underline" target="_blank" rel="noopener">
        ...
        <div className="row align-items-center">
          <div className="col-sm-10 " style={{ display: 'flex' }}>
            <button type="submit" className="btn btn-primary" onClick={onSubmit} data-email="yes" disabled={!!progressMessage}>
              Proceed with Email
            </button>
            <button type="submit" className="btn btn-ghost-secondary" onClick={onSubmit} data-email="no" disabled={!!progressMessage}>
        ...
        <div className="row mt-4">
          <div className="col-sm-12">
            <Spinner as="span" animation="border" role="status" size="sm" aria-hidden="true" hidden={!progressMessage}></Spinner>{' '}
...
//# sourceMappingURL=ConfigureSession.jsx.map