    ...
    return (<div className="container space-2">
      ...
      <div className="row mx-n2">
        <div className="col-sm-6 col-lg-3 px-2 mb-3 mb-lg-0">
          <a className="card h-100 transition-3d-hover" href={`${process.env.NEXT_PUBLIC_GOLDSTACK_DOCS}/goldstack/about`}>
        ...
        <div className="col-sm-6 col-lg-3 px-2">
          <a className="card h-100 transition-3d-hover" href={process.env.NEXT_PUBLIC_GOLDSTACK_DOCS}>
            <div className="card-body">
              <figure className="w-100 max-w-8rem mb-4">
...
//# sourceMappingURL=GoldstackBenefits.jsx.map