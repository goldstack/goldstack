...
const _DocLinkItem = (props) => {
    return (<a className="card card-frame py-3 px-4 mb-3" href={props.link.link}>
...
const DocsLinks = (props) => {
    return (<>
      ...
      <div>
        <div className="mb-2">
          <a href="https://docs.goldstack.party/docs/goldstack/getting-started" target="_blank" rel="noreferrer">
            Project Setup
          </a>
        </div>
        {props.data.map((docLink, idx) => (<div key={docLink.link} className="mb-2">
            <a href={docLink.link} target="_blank" rel="noreferrer">{`${docLink.packageName} Module`}</a>
          </div>
    ...
    return (<>
      <div>
        <div className="position-relative z-index-2 text-center">
          <div className="d-inline-block font-size-1 border bg-white text-center rounded-pill py-3 px-4">
            Any problems?{' '}
            <a className="font-weight-bold ml-3" target="_blank" rel="noreferrer" href="https://github.com/goldstack/goldstack/issues">
      ...
      <DownloadInstructionsStep stepNumber={1} title="Configure AWS Deployment">
        ...
        <div className="mb-3 mt-3">
          <a className="btn btn-outline-primary btn-pill transition-3d-hover px-5" href={`/projects/${props.projectId}/packages/${props.packageId}/configure/1`}>
      ...
      <DownloadInstructionsStep stepNumber={3} title="Extract project">
        ...
        <img className="img-fluid" src="https://cdn.goldstack.party/img/202201/extract_project.gif" alt="Extracting the project ZIP file"></img>
      </DownloadInstructionsStep>
      <DownloadInstructionsStep stepNumber={4} title="Open extracted folder in VSCode">
        ...
        <img className="img-fluid mb-4" src="https://cdn.goldstack.party/img/202201/open_folder.png" alt="Opening folder in VSCode"></img>
        <p>
          VSCode may prompt you to ask if you trust the authors of the workspace. Respond with{' '}
          <i>Yes</i>.
        </p>
        <img className="img-fluid mb-4" style={{ maxWidth: '500px' }} src="https://cdn.goldstack.party/img/202201/trust_authors.png" alt="Trusting authors prompt in VSCode"></img>
        <p>
        ...
        <img className="img-fluid mb-4" src="https://cdn.goldstack.party/img/202201/install_extensions.png" alt="Installing extensions prompt in VSCode"></img>
      </DownloadInstructionsStep>
      <DownloadInstructionsStep stepNumber={5} title="Install project dependencies and build project">
        <p>
        ...
        <div className="font-size-1">
          <span>
            ...
            <a href="https://docs.npmjs.com/downloading-and-installing-node-js-and-npm#checking-your-version-of-npm-and-nodejs" target="_blank" rel="noreferrer">
              install Node.js
            </a>
            .
          </span>
        ...
        <img className="img-fluid" src="https://cdn.goldstack.party/img/202202/node_and_yarn.gif" alt="Running yarn commands in terminal"></img>
      </DownloadInstructionsStep>
      ...
      <DownloadInstructionsStep stepNumber={6} title="Initialise TypeScript">
        ...
        <img className="img-fluid" src="https://cdn.goldstack.party/img/202201/allow_typescript.gif" alt="Allowing workspace TypeScript version"></img>
      </DownloadInstructionsStep>
      ...
      <DownloadInstructionsStep stepNumber={7} title="Start working with the project">
        ...
        <img className="img-fluid mb-4" src="https://cdn.goldstack.party/img/202201/yarn_watch.gif" alt="Running yarn watch command"></img>
...
//# sourceMappingURL=DownloadInstructions.jsx.map