...
const ProjectTemplateFeature = (props) => {
    return (<a href={props.feature.details ? `#${props.feature.id || ''}` : '#'} className={`media border border-light mb-4 p-2 ${styles['clickable-media']}`}>
...
const ProjectTemplateFeatures = (props) => {
    return (<>
...
//# sourceMappingURL=ProjectTemplateFeatures.jsx.map