...
const ProjectTemplate = (props) => {
    ...
    return (<>
      <Head>
        ...
        <meta property="og:title" content={props.metaTitle || `${props.title} Template`} key="title"/>
      ...
      <div className="container space-top-2 space-bottom-lg-2">
        <div className="row">
          <ProjectTemplateSidebar tags={props.tags || []} image={props.images[0]} isComposite={props.isComposite} packages={props.packages} actionLink={props.actionLink} boilerplateLink={props.boilerplateLink}></ProjectTemplateSidebar>
...
//# sourceMappingURL=ProjectTemplate.jsx.map