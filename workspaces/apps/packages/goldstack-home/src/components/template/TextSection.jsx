    ...
    return (<div className="container space-2">
      <div className="row justify-content-lg-between align-items-lg-center">
        <div className="col-lg-5 mb-9 mb-lg-0">
          ...
          {props.action && (<div className="mt-4">
              <a className="btn btn-primary btn-wide transition-3d-hover" href={props.action.link}>
                {props.action.title}
              </a>
            </div>)}
        </div>
        ...
        <div className="col-lg-6 col-xl-5">
          <div className="position-relative min-h-500rem mx-auto" style={{ maxWidth: '28rem' }}>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 515 515" width="200" height="200">
                <g>
                  ...
                  <g clipPath="url(#circleImgID3)">
                    <image width="515" height="515" xlinkHref={TabletImg.src} transform="matrix(1 0 0 1 1.639390e-02 2.880859e-02)"></image>
                  </g>
                </g>
              </svg>
            </figure>

            <figure className="position-absolute top-0 right-0" style={{ marginTop: '11rem', marginRight: '13rem' }}>
            ...
            <figure className="position-absolute top-0 right-0 mr-3" style={{ marginTop: '8rem' }}>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 770.4 770.4" width="280" height="280">
                <g>
                  ...
                  <g clipPath="url(#circleImgID5)">
                    <image width="900" height="900" xlinkHref={MeetingImg.src} transform="matrix(1 0 0 1 -64.8123 -64.8055)"></image>
                  </g>
                </g>
              </svg>
            </figure>
...
//# sourceMappingURL=TextSection.jsx.map