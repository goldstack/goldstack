...
const TemplateCard = (props) => {
    return (<div className={`card border shadow-none d-block ${styles['package-card']} `}>
      <div className="card-body d-flex align-items-center p-0">
        <div className="w-35 ">
          <img className={`img-fluid ${styles['card-image']}`} src={resolveImage(props.template.images[0])} alt="Template Image 1"/>
        </div>
      ...
      <div className="card-footer text-center py-4">
        ...
        <a className="btn btn-sm btn-outline-primary btn-pill transition-3d-hover px-5 " href={`/templates/${props.template.id}`}>
          View Template
        </a>
      </div>
    </div>);
...
//# sourceMappingURL=TemplateCard.jsx.map