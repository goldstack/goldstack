const FeatureProjectInstall = (props) => {
    return (<div className="card bg-navy mb-5 w-md-80 w-lg-50 mx-md-auto text-left">
...
//# sourceMappingURL=FeatureProjectInstall.jsx.map