...
describe('Goldstack API', () => {
  it('Create a project', async () => {
    ...
    const cookie = session.cookies.find(
      (cookie: any) => cookie.name === 'userToken'
    );
    ...
    expect(get2Res.body.packageConfigs[0].package.configuration.dummy).toEqual(
      'hello'
    );
