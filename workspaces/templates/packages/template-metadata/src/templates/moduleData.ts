...
const NextJs: PackageProps = {
  title: 'Next.js',
  link: 'https://github.com/goldstack/goldstack/tree/master/workspaces/templates/packages/app-nextjs#readme',
...
const DynamoDB: PackageProps = {
  title: 'DynamoDB',
  link: 'https://github.com/goldstack/goldstack/tree/master/workspaces/templates/packages/dynamodb#readme',
