...
class InfraUpTest {
  ...
  async runTest(params) {
    ...
    for (const deployment of packageConfig.deployments) {
      ...
      (0, utils_yarn_1.yarn)(params.projectDir, `workspace ${packageJson.name} build`);
      (0, utils_yarn_1.yarn)(
        params.projectDir,
...
exports.InfraUpTest = InfraUpTest;
//# sourceMappingURL=InfraUpTest.js.map
